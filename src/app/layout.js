        ...
        <header id="header">
          <div className="d-flex flex-column">
            ...
            <nav id="navbar" className="nav-menu navbar">
              <ul>
                <li><a href="/ahasan-portfolio/" className="nav-link scrollto active"><i className="bx bx-home"></i> <span>Home</span></a></li>
                <li><a href="/ahasan-portfolio/about" className="nav-link scrollto"><i className="bx bx-user"></i> <span>About</span></a></li>
                <li><a href="/ahasan-portfolio/blog" className="nav-link scrollto"><i className="bx bx-file-blank"></i> <span>Blog</span></a></li>
